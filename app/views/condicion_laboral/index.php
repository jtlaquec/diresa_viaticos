<div>
    <div>
        ...
        <div>
                <input class="px-2 py-1 rounded" type="text" id="searchInput" placeholder="Buscar Condiciones Laborales..." style="width: 600px; border: 2px solid gray; color:black;" autocomplete="off">
            </div>
